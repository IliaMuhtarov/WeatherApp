            ...
            Column(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = if(currentDay.value.momentTemp.isNotEmpty())
                                currentDay.value.momentTemp.toFloat().toInt().toString() + "°С"
                        ...
                        Row(
                            ...
                            Text(
                                text = "${currentDay
                                    .value.maxTemp.toFloat().toInt()}°С/ ${currentDay
